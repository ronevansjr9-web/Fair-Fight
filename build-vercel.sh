...
echo "[1/3] vite build (skipping bun install — disk full, deps already present)"
# Skip bun install due to sandbox disk constraints — node_modules must already exist
bun run build
