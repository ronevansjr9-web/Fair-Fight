...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-CcNrkObX.js");
...
const manifest = {
  ...
  "c960787ec9a553a77dbdde3313b39cc569b31b3a3e3cbc4ea4944aa965eaaa9f": {
    ...
    importer: () => import("./assets/dashboard-BSP5mURc.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-CPaV_2AK.js").then((n) => n.r),
