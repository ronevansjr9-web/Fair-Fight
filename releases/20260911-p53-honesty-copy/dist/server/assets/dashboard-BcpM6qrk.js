...
import { a as Route, t as trackEvent, c as createSsrRpc, A as AnalyticsEvents } from "./router-CPaV_2AK.js";
      ...
      loading ? /* @__PURE__ */ jsx("div", { className: "p-12 text-center", children: /* @__PURE__ */ jsx("div", { className: "mx-auto h-8 w-8 animate-spin rounded-full border-4 border-gold border-t-transparent" }) }) : loadError ? /* @__PURE__ */ jsxs("div", { className: "p-12 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-1 flex flex-wrap items-center gap-2", children: [
            ...
            data.entitlementStatus === "error" ? /* @__PURE__ */ jsx("span", { title: "We couldn't verify your analysis access right now. Refresh the page to try again.", className: "rounded-full border border-white/10 px-2 py-0.5 text-xs font-medium text-white/40", children: "Unable to verify analysis access — try refreshing" }) : data.entitledCaseIds.includes(c.id) ? /* @__PURE__ */ jsx(Link, { to: "/analysis", search: {
              caseId: c.id,
              checkout: void 0
