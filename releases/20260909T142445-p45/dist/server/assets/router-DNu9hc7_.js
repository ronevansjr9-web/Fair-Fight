...
import { useNavigate, useLocation, ScriptOnce, useRouter, createRootRoute, Outlet, HeadContent, Scripts, Link, createFileRoute, lazyRouteComponent, redirect, createRouter } from "@tanstack/react-router";
import React, { useTransition, useEffect, useRef, useState } from "react";
import { InternalClerkProvider, setErrorThrowerOptions } from "@clerk/react/internal";
import "@clerk/shared/getToken";
import { useAuth, useSignIn, UserButton, SignInButton, SignUpButton } from "@clerk/react";
import { buildErrorThrower } from "@clerk/shared/error";
import { getEnvVariable } from "@clerk/shared/getEnvVariable";
import { isTruthy } from "@clerk/shared/underscore";
import { htmlSafeJson } from "@clerk/shared/htmlSafeJson";
import { g as getStartContext, T as TSS_SERVER_FUNCTION, a as getServerFnById, c as createServerFn } from "../server.js";
import "@neondatabase/serverless";
import { s as sql } from "./db-D7cnbd5l.js";
import { json } from "@tanstack/router-core/ssr/client";
import Stripe from "stripe";
import { c as checkoutPolicy, p as paymentFromCheckoutSession, m as markPaymentRefunded, h as hasWebhookEvent, r as recordWebhookEvent, a as recordSuccessfulPayment, i as isCaseOwner } from "./argumentAccess-Brc0Ql3j.js";
...
buildErrorThrower({ packageName: "@clerk/tanstack-react-start" });
...
const pickFromClerkInitState = (clerkInitState) => {
...
const mergeWithPublicEnvs = (restInitState) => {
...
function ClerkProvider({ children, ...providerProps }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(ScriptOnce, { children: `window.__clerk_init_state = ${htmlSafeJson(clerkInitialState)};` }), /* @__PURE__ */ jsx(ClerkOptionsProvider, {
    options: mergedProps,
...
function makeRandomId() {
  return typeof crypto !== "undefined" && typeof crypto.randomUUID === "function" ? crypto.randomUUID() : `s_${Date.now().toString(36)}_${Math.random().toString(36).slice(2, 10)}`;
}
...
function buildTrackPayload(params) {
  return {
    route: params.route,
    ref: params.ref ?? null,
    utm: params.utm ?? null,
...
function sendAnalyticsBody(payload) {
  if (typeof window === "undefined") return;
  try {
...
function currentContext() {
  const ref = typeof document !== "undefined" && document.referrer ? document.referrer.slice(0, 1e3) : null;
  return {
...
function getTicketFromSearch(search) {
  if (!search) return "";
  return new URLSearchParams(search).get(TICKET_PARAM) ?? "";
}
function withoutTicketParam(search, pathname = "") {
...
async function consumeTicket(adapter, ticket) {
...
function SignInTicketHandler() {
  ...
  useEffect(() => {
    ...
    const adapter = signIn && typeof signIn.create === "function" ? {
    ...
    (async () => {
      if (!adapter) return;
      await consumeTicket(adapter, ticket).catch(() => void 0);
    })().finally(() => {
      cleanupTicketParam();
    });
...
function RouteVisitTracker() {
  ...
  useEffect(() => {
    const fire = () => {
      const route = getLocationRoute(router2.state.location);
      if (route === lastSent.current) return;
      lastSent.current = route;
      trackPageView(route);
    };
    fire();
    return router2.subscribe("onResolved", fire);
  }, [router2]);
  return null;
}
const appCss = "/assets/app-tZ9BKq1W.css";
...
const Route$l = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Fair Fight provides plain-English legal education, public guides, and a paid Pro Case Analysis workspace for people preparing to speak with an attorney. It is not a law firm and does not provide legal advice."
      },
      ...
      { property: "og:title", content: "Fair Fight — Legal Education & Pro Case Analysis" },
      {
        ...
        content: "Plain-English legal education, public guides, and a paid Pro Case Analysis workspace for people preparing to speak with an attorney. Not legal advice."
      },
      ...
      { name: "twitter:title", content: "Fair Fight — Legal Education & Pro Case Analysis" },
      {
        ...
        content: "Plain-English legal education and paid Pro Case Analysis for people preparing to speak with an attorney. Not legal advice."
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Fair Fight",
          description: "Fair Fight helps you understand your legal situation with plain-English education, public legal resources, case organization, and paid Pro Case Analysis. It is not a law firm and does not provide legal advice.",
...
function RootComponent() {
  return /* @__PURE__ */ jsxs(RootDocument, { children: [
    /* @__PURE__ */ jsx(AuthTracker, {}),
    /* @__PURE__ */ jsx(RouteVisitTracker, {}),
    /* @__PURE__ */ jsx(SignInTicketHandler, {}),
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-50 border-b border-white/10 bg-navy shadow-lg", children: [
    /* @__PURE__ */ jsxs("div", { className: "mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-x-4 gap-y-2 px-3 py-3 sm:px-4", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6 md:gap-8", children: [
        /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { className: "text-gold", children: "⚖️" }),
              "Fair Fight"
            ]
          }
        ),
        /* @__PURE__ */ jsxs("nav", { className: "hidden items-center gap-6 md:flex", "aria-label": "Primary", children: [
          /* @__PURE__ */ jsx(Link, { to: "/learn", className: "nav-link", children: "Guides" }),
          auth.isSignedIn && /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(Link, { to: "/dashboard", className: "nav-link", children: "Dashboard" }),
            /* @__PURE__ */ jsx(Link, { to: "/chat", className: "nav-link", children: "Chat" }),
            /* @__PURE__ */ jsx(Link, { to: "/evidence", className: "nav-link", children: "Evidence" }),
            /* @__PURE__ */ jsx(Link, { to: "/calendar", className: "nav-link", children: "Calendar" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-3", children: auth.isSignedIn ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          Link,
          {
            to: "/profile",
        ...
        /* @__PURE__ */ jsx(SignInButton, { mode: "modal", children: /* @__PURE__ */ jsx("button", { className: "rounded-full border border-white/20 px-4 py-1.5 text-sm font-medium text-white/80 transition-all hover:bg-white/10", children: "Sign In" }) }),
        /* @__PURE__ */ jsx(SignUpButton, { mode: "modal", children: /* @__PURE__ */ jsx("button", { className: "gold-gradient rounded-full px-4 py-1.5 text-sm font-semibold text-navy", children: "Get Started" }) })
      ] }) })
    ] }),
    auth.isSignedIn && /* @__PURE__ */ jsxs(
      "nav",
      {
        id: "mobile-nav-menu",
        "aria-label": "Mobile",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                SIGNED_IN_MOBILE_LINKS.map((link) => /* @__PURE__ */ jsx(
                  Link,
                  {
                    to: link.to,
                    onClick: () => setMobileOpen(false),
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { children: [
      /* @__PURE__ */ jsx(ClerkProvider, { publishableKey: PUBLISHABLE_KEY, children }),
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs("p", { style: { fontSize: "0.75rem", fontWeight: 500, color: "rgba(255,255,255,0.8)", margin: 0 }, children: [
            /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { marginRight: "0.375rem" }, children: "⚖️" }),
      ...
      /* @__PURE__ */ jsx("noscript", { children: /* @__PURE__ */ jsx("div", { style: { padding: "8px", textAlign: "center", backgroundColor: "#0A2342", color: "white", fontSize: "12px" }, children: "⚖️ For educational purposes only. Fair Fight is not a law firm and does not provide legal advice. Always consult with a qualified attorney." }) })
    ] })
  ] });
}
const $$splitComponentImporter$i = () => import("./timeline-0kEbxgy4.js");
const Route$k = createFileRoute("/timeline")({
  validateSearch: (search) => ({
    caseId: typeof search.caseId === "string" ? search.caseId : void 0
  }),
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Build a chronological timeline of events for your legal case."
    }]
  })
});
const $$splitComponentImporter$h = () => import("./research-D5tND77d.js");
const Route$j = createFileRoute("/research")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Search public case law via CourtListener and explore statutes, court rules, and legal concepts. This educational research tool is separate from Fair Fight's paid Pro Case Analysis workspace; not legal advice."
    }]
  })
});
const $$splitComponentImporter$g = () => import("./profile-DBS_wWLB.js");
const Route$i = createFileRoute("/profile")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Manage your Fair Fight profile, billing, and account settings."
    }]
  })
});
const $$splitComponentImporter$f = () => import("./privacy-RtiZ0IPA.js");
const Route$h = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Fair Fight privacy policy — how we collect, use, and protect your data."
    }]
  })
});
...
const $$splitComponentImporter$e = () => import("./legal-argument-BgAhulGe.js");
const Route$g = createFileRoute("/legal-argument")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Generate AI-powered legal argument templates with jurisdiction-specific case law citations. Temporarily unavailable while Pro activation is verified. Educational purposes only — not legal advice."
    }]
  })
});
const getUserCases = createServerFn({
  method: "GET"
}).handler(createSsrRpc("44d77e1a0aabca096b6d26cfb2779f0ef7ff3a9da2296720cc2e86f808872c2b"));
const $$splitComponentImporter$d = () => import("./learn-BDMl1Bf3.js");
const Route$f = createFileRoute("/learn")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./evidence-BT3tHjvq.js");
const Route$e = createFileRoute("/evidence")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The Evidence Manager — organizing and uploading case evidence — is temporarily unavailable while we verify durable file storage. Educational purposes only — not legal advice."
    }]
  })
});
createServerFn({
...
const $$splitComponentImporter$b = () => import("./documents-3ShFxuMU.js");
const Route$d = createFileRoute("/documents")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The Legal Document Generator is temporarily unavailable while we verify Pro activation. Educational purposes only — not legal advice."
    }]
  })
});
createServerFn({
...
}).handler(createSsrRpc("65957c43ca2e4fdd5072672cc4223904e65c2478d2112cdd779215e0089558b0"));
const $$splitComponentImporter$a = () => import("./data-request-CDqAt80e.js");
const Route$c = createFileRoute("/data-request")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Request a copy of your data or delete your Fair Fight data. Export and deletion cover all data you own, scoped to your account."
    }]
  })
});
const $$splitComponentImporter$9 = () => import("./dashboard-46pNU4TG.js");
const Route$b = createFileRoute("/dashboard")({
  validateSearch: (search) => ({
    checkout: search.checkout || void 0
  }),
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your Fair Fight dashboard — manage cases, timelines, court calendar, and legal education tools."
    }]
  })
});
const $$splitComponentImporter$8 = () => import("./chat-BZjtApAa.js");
const Route$a = createFileRoute("/chat")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The AI Legal Education Chat is temporarily unavailable while we verify Pro activation. Educational purposes only — not legal advice."
    }]
  })
});
createServerFn({
...
const $$splitComponentImporter$7 = () => import("./calendar-BXbVm0Ay.js");
const Route$9 = createFileRoute("/calendar")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Court Calendar is temporarily unavailable while we verify deadline handling. Do not rely on Fair Fight for filing deadlines; confirm dates with the court or an attorney."
    }]
  })
});
const $$splitComponentImporter$6 = () => import("./analysis-JI4eGF9E.js");
const Route$8 = createFileRoute("/analysis")({
  validateSearch: (search) => ({
    caseId: search.caseId || void 0,
    checkout: search.checkout || void 0
  }),
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Fair Fight Pro Case Analysis: a plain-English summary, possible legal issues, candidate arguments, counterarguments, and traceable public sources — educational, not legal advice."
    }]
  })
});
const $$splitComponentImporter$5 = () => import("./admin-NeKNOb6b.js");
const Route$7 = createFileRoute("/admin")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Fair Fight administrative dashboard."
    }]
  })
});
const $$splitComponentImporter$4 = () => import("./index-BDJNyZYL.js");
...
const SITE_ORIGIN = "https://fairfight.ctonew.app";
function guideUrl(slug) {
  return `${SITE_ORIGIN}/learn/${slug}`;
}
const $$splitComponentImporter$3 = () => import("./index-DBUzBZW6.js");
const Route$5 = createFileRoute("/learn/")({
  validateSearch: (search) => ({
    article: search.article || void 0
  }),
  head: ({
    search
  }) => {
      ...
      if (article) {
        ...
        return {
          meta: [{
            ...
            property: "og:title",
            content: `${article.title} | Fair Fight`
          }, {
            property: "og:description",
            content: description
          }, {
    ...
    return {
      meta: [{
        ...
        name: "description",
        content: "Public plain-English legal guides on court procedures, motions, discovery, statutes of limitations, criminal law, family law, housing law, debt collection, and more. Fair Fight's paid Pro Case Analysis workspace is separate from these educational guides."
      }]
    };
  },
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const GUIDE_LIBRARY_DATE = "2026-08-24";
const HOME_URL = `${SITE_ORIGIN}/`;
const LEARN_URL = `${SITE_ORIGIN}/learn`;
const HOW_TO_BY_SLUG = /* @__PURE__ */ new Set([
  "eviction-process-guide",
  "small-claims-court-guide"
]);
const HOW_TO_TITLE_RE = /(^how to\b|step[\s-]?by[\s-]?step)/i;
function isHowToGuide(article) {
...
function guideStructuredDataScripts(article) {
  const blocks = [
...
const $$splitComponentImporter$2 = () => import("./_slug-BbR1Z2Ra.js");
const Route$4 = createFileRoute("/learn/$slug")({
    ...
    if (!article) {
      return {
        meta: [{
          ...
          name: "description",
          content: "This public legal-education guide could not be found. Browse all public guides at Fair Fight."
        }]
      };
    }
    const description = article.paragraphs[0].substring(0, 160);
...
const $$splitComponentImporter$1 = () => import("./new-BxpRIBlh.js");
const Route$3 = createFileRoute("/cases/new")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Create a new legal case on Fair Fight to track important dates and court deadlines and get AI-powered legal education."
    }]
  })
});
const $$splitComponentImporter = () => import("./_caseId-K4l80eGO.js");
const Route$2 = createFileRoute("/cases/$caseId")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Your Fair Fight case workspace — case details and tools for tracking deadlines and preparing for attorney conversations."
    }]
  })
});
const MAX_ROUTE = 500;
...
function parseTrackBody(raw) {
  ...
  let ref = null;
  if (body.ref !== void 0 && body.ref !== null) {
  ...
  let ev = null;
  if (body.ev !== void 0 && body.ev !== null) {
  ...
  let utm = null;
  if (body.utm !== void 0 && body.utm !== null) {
...
const Route$1 = createFileRoute("/api/track")({
  server: { handlers: { POST: ({ request }) => handlePost$1(request) } }
});
...
async function processCheckoutCompleted(event, deps) {
...
async function processRefundEvent(event, deps) {
...
async function handlePost(request) {
  ...
  const deps = {
    ...
    stripe: {
      async retrieveCheckoutLineItemPriceId(sessionId) {
        try {
...
const Route = createFileRoute("/api/stripe/webhook")({
  server: { handlers: { POST: ({ request }) => handlePost(request) } }
});
const TimelineRoute = Route$k.update({
  id: "/timeline",
  path: "/timeline",
  getParentRoute: () => Route$l
});
const ResearchRoute = Route$j.update({
  id: "/research",
  path: "/research",
  getParentRoute: () => Route$l
});
...
const LegalArgumentRoute = Route$g.update({
  id: "/legal-argument",
  path: "/legal-argument",
  getParentRoute: () => Route$l
});
const LearnRoute = Route$f.update({
  id: "/learn",
  path: "/learn",
  getParentRoute: () => Route$l
});
const EvidenceRoute = Route$e.update({
  id: "/evidence",
  path: "/evidence",
  getParentRoute: () => Route$l
});
const DocumentsRoute = Route$d.update({
  id: "/documents",
  path: "/documents",
  getParentRoute: () => Route$l
});
const DataRequestRoute = Route$c.update({
  id: "/data-request",
  path: "/data-request",
  getParentRoute: () => Route$l
});
...
const ChatRoute = Route$a.update({
  id: "/chat",
  path: "/chat",
  getParentRoute: () => Route$l
});
const CalendarRoute = Route$9.update({
  id: "/calendar",
  path: "/calendar",
  getParentRoute: () => Route$l
});
const AnalysisRoute = Route$8.update({
  id: "/analysis",
  path: "/analysis",
  getParentRoute: () => Route$l
});
...
const LearnIndexRoute = Route$5.update({
  id: "/",
  path: "/",
  getParentRoute: () => LearnRoute
});
const LearnSlugRoute = Route$4.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => LearnRoute
});
const CasesNewRoute = Route$3.update({
  id: "/cases/new",
  path: "/cases/new",
  getParentRoute: () => Route$l
});
const CasesCaseIdRoute = Route$2.update({
  id: "/cases/$caseId",
  path: "/cases/$caseId",
  getParentRoute: () => Route$l
});
const ApiTrackRoute = Route$1.update({
  id: "/api/track",
  path: "/api/track",
  getParentRoute: () => Route$l
});
const ApiStripeWebhookRoute = Route.update({
  id: "/api/stripe/webhook",
  path: "/api/stripe/webhook",
  getParentRoute: () => Route$l
});
const LearnRouteChildren = {
  LearnSlugRoute,
  LearnIndexRoute
};
