...
import { c as createSsrRpc } from "./router-DNu9hc7_.js";
...
function DocumentsPage() {
  return /* @__PURE__ */ jsx(AuthenticatedGuard, { children: /* @__PURE__ */ jsx("main", { className: "min-h-screen bg-navy px-4 py-12", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl", children: [
    /* @__PURE__ */ jsx("h1", { className: "mb-2 text-3xl font-extrabold text-white", children: "Document Generator" }),
    /* @__PURE__ */ jsx("p", { className: "mb-8 text-white/70", children: "The AI Document Generator — creating educational legal document templates — is temporarily unavailable while we verify Pro activation." }),
    /* @__PURE__ */ jsxs("div", { className: "rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-8", children: [
      ...
      /* @__PURE__ */ jsx("h2", { className: "mb-2 text-center text-xl font-bold text-white", children: "The Document Generator is temporarily unavailable" }),
      /* @__PURE__ */ jsx("p", { className: "mx-auto mb-6 max-w-xl text-center text-sm text-white/70", children: TEMP_UNAVAILABLE_MESSAGE }),
      /* @__PURE__ */ jsx("p", { className: "mx-auto max-w-xl text-center text-sm text-white/60", children: "Document generation is a paid AI tool. We are verifying Pro activation before making it available. When it is restored, outputs will be educational templates only — not filing-ready documents or legal advice. Your legal education, legal research, and core case tools continue to work." })
    ] })
  ] }) }) });
}
export {
